...
class KeycloakService {
  ...
  private async performInit(): Promise<boolean> {
    try {
      ...
      // IMPORTANT: Use 'check-sso' instead of 'login-required' for public access
      const authenticated = await this.keycloak.init({
        onLoad: 'check-sso', // This allows public access without forcing login
